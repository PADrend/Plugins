...
PADrend.Navigation.init := fn(){
...

	{
		...
		registerExtension('PADrend_UIEvent',this->ex_UIEvent,Extension.HIGH_PRIORITY);
...
//! [ext:PADrend_UIEvent]
PADrend.Navigation.ex_UIEvent := fn(evt){
	...
	if(this.cameraMover.handleEvent(evt,false))
		return true;
	return false;
};
